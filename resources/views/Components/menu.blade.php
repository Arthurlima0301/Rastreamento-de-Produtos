<flux:dropdown position="bottom" align="end">
    ...
    <flux:navmenu>
        ...
        <flux:menu.group heading="Insumos">
            <flux:navmenu.item href="{{ route('supply-invoices.index') }}" icon="document-text">Notas Fiscais de Insumo</flux:navmenu.item>
            <flux:navmenu.item href="{{ route('supply-items.index') }}" icon="rectangle-stack">Itens de Insumo</flux:navmenu.item>
